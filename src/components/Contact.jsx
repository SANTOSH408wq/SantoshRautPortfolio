          ...
          <div className="contact__info">
            <div className="contact__info-card">
              ...
              <div>
                ...
                <p className="contact__info-value">sraut7105@gmail.com</p>
              </div>
            </div>
            ...
            <div className="contact__info-card">
              ...
              <div>
                ...
                <p className="contact__info-value">Vasai (E), Maharashtra, India</p>
              </div>
            </div>
            ...
            <div className="contact__info-card">
              <div className="contact__info-icon">💼</div>
              <div>
                <h4 className="contact__info-title">Availability</h4>
                <p className="contact__info-value">Open for opportunities</p>
              </div>
            </div>

            <div className="contact__socials">
              <a href="https://github.com/SANTOSH408wq" className="contact__social-link" aria-label="GitHub">
              ...
              <a href="https://x.com/Santosh25218817" className="contact__social-link" aria-label="Twitter">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/_santosh.raut/" className="contact__social-link" aria-label="Instagram">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
